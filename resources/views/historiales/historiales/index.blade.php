                ...
                <div class="crud-panel">
                    <div class="panel-body">
                       ...
                       {{--<form action="{{ route('exportpdf') }}" method="post">
                        ...
                        <a href="{{ route('historiales.exportpdf',$data) }}" title="View Personal"><button class="btn btn-primary mb1 bg-red btn-sm"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Exportar busqueda</button></a>
                        
                        <a href="{{ route('historiales.exportxls',$data) }}" class="btn btn-success">Export to .xls</a>
