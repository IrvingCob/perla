        ...
        <div class="row">
            <div class="col-md-11">
                <div id="mario" class="panel panel-success">
                    <div class="panel panel-heading"><center><h4> MODIIFICAR STATUS </h4></center></div>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/status/status/' . $status->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
