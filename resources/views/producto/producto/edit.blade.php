        ...
        <div class="row">
            <div class="col-md-11">
                <div id="mario" class="panel panel-success">
                    <div class="panel panel-heading"><center><h4> MODIIFICAR PRODUCTO </h4></center></div>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/producto/producto/' . $producto->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
