                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="TFtable">
                                <thead>
                                    <tr id="columna1">
                                        <th>#</th><th>producto</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($producto as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nombre }}</td>
                                        <td>
                                            <a href="{{ url('/producto/producto/' . $item->id) }}" title="View Bitacora"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                            <a href="{{ url('/producto/producto/' . $item->id . '/edit') }}" title="Edit Bitacora"><button class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
