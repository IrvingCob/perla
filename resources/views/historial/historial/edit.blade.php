        ...
        <div class="row">
            ...
            <div class="col-md-11">
                <div id="mario" class="panel panel-success">
                    <div class="panel panel-heading"><center><h4> MODIFICAR HISTORIAL DE {{ $nombre }} </h4></center></div>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/historial/historial/' . $historial->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                            @include ('historial.historial.form', ['formMode' => 'edit'])
