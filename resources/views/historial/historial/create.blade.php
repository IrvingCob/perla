        ...
        <div class="row">
            <div class="col-md-11">
                <div id="mario" class="panel panel-success">
                    <div class="panel panel-heading"><center><h4> NUEVO HISTORIAL PARA {{ $nombre }} </h4></center></div>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/historial/historial') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="vendor_id" value={{ $data_vendor->id }}>
                            @include ('historial.historial.formCreate', ['formMode' => 'create'])
