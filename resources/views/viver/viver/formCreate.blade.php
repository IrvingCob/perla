...
<div class="form-group {{ $errors->has('nombre') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4">
    <input required class="form-control" name="nombre" type="text" id="nombre" value="{{ isset($viver->nombre) ? $viver->nombre : ''}}" >
...
<div class="form-group {{ $errors->has('cantidad') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4">
    <input oninput="calculate()" required class="form-control" name="cantidad" type="number" id="cantidad" value="{{ isset($viver->cantidad) ? $viver->cantidad : ''}}" >
...
<div class="form-group {{ $errors->has('importe') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4">
    <input type="number" name="importe" class="form-control" id="importe"  required >
...
<div class="col-md-4">
    <input required class="form-control" name="fecha" type="date" id="fecha" value="{{ isset($viver->fecha) ? $viver->fecha : ''}}" >
